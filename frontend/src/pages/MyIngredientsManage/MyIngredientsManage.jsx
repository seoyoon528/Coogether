...
function MyIngredientsManage() {
  ...
  useEffect(() => {
    const getData = async () => {
      try {
        ...
        const response = await axios.get(
          `https://i8b206.p.ssafy.io:9000/ingredient/list/total/${query}`
        );
  ...
  useEffect(() => {
    const getAllData = async () => {
      try {
        const response = await axios.get(
          'https://i8b206.p.ssafy.io:9000/ingredient/list/total'
        );
  ...
  useEffect(() => {
    const getData = async () => {
      try {
        ...
        const response = await axios.get(
          `https://i8b206.p.ssafy.io:9000/ingredient/list/my/1/${query}`
        );
